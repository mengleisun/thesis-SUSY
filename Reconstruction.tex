...
Muons can be reconstructed in a inside-out, outside-in or standalone way in CMS~\cite{MuonPF}.
...
Such anomalous signals includes unphysical energy deposits in the calorimeter, noise of detector, beam-induced backgrounds, and poorly instrumented regions of the detector.
